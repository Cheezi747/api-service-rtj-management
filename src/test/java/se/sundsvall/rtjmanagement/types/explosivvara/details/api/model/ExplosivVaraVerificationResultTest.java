...
class ExplosivVaraVerificationResultTest {

	@Test
	void testBean() {
		assertThat(ExplosivVaraVerificationResult.class, allOf(
	...
	void testBuilderMethods() {
		final var result = ExplosivVaraVerificationResult.create()
	...
	void testNoDirtOnCreatedBean() {
		assertThat(ExplosivVaraVerificationResult.create()).hasAllNullFieldsOrProperties();
	}
}
