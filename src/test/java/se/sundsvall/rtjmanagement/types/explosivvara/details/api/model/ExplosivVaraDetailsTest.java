...
class ExplosivVaraDetailsTest {
	...
	@Test
	void testBean() {
		assertThat(ExplosivVaraDetails.class, allOf(
	...
	void testNoDirtOnCreatedBean() {
		...
		assertThat(ExplosivVaraDetails.create()).hasAllNullFieldsOrPropertiesExcept("isProxy");
	}
}
