...
class ApplicantResponsiblePersonTest {

	@Test
	void testBean() {
		assertThat(ApplicantResponsiblePerson.class, allOf(
	...
	void testBuilderMethods() {
		final var result = ApplicantResponsiblePerson.create()
			.withFirstName("Anna")
	...
	void testNoDirtOnCreatedBean() {
		assertThat(ApplicantResponsiblePerson.create()).hasAllNullFieldsOrProperties();
	}
}
