...
class EgensotningValidityCalculatorTest {
	...
	void sixYearsSnappedToNextFixedDate() {
		...
		assertThat(EgensotningValidityCalculator.computeValidUntil(LocalDate.of(2026, 1, 1)))
	...
	void baseExactlyOnFixedDateIsKept() {
		...
		assertThat(EgensotningValidityCalculator.computeValidUntil(LocalDate.of(2026, 6, 1)))
	...
	void baseBetweenFixedDatesSnapsUp() {
		...
		assertThat(EgensotningValidityCalculator.computeValidUntil(LocalDate.of(2026, 4, 10)))
			.isEqualTo(LocalDate.of(2032, 6, 1));
	}
	...
	void baseAfterDecemberRollsToNextYearMarch() {
		...
		assertThat(EgensotningValidityCalculator.computeValidUntil(LocalDate.of(2026, 12, 15)))
	...
	void leapDayBaseIsNormalisedThenSnapsUp() {
		...
		assertThat(EgensotningValidityCalculator.computeValidUntil(LocalDate.of(2024, 2, 29)))
