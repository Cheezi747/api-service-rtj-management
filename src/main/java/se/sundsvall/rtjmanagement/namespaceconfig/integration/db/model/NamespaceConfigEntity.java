package se.sundsvall.rtjmanagement.namespaceconfig.integration.db.model;
...
public class NamespaceConfigEntity implements Auditable {
	...
	public boolean equals(final Object obj) {
		...
		return Objects.equals(created, other.created) && Objects.equals(displayName, other.displayName) && Objects.equals(id, other.id) && Objects.equals(modified, other.modified) && Objects.equals(municipalityId, other.municipalityId) && Objects.equals(
			namespace, other.namespace) && Objects.equals(shortCode, other.shortCode);
	}

	@Override
	public String toString() {
		return "NamespaceConfigEntity [id=" + id + ", municipalityId=" + municipalityId + ", namespace=" + namespace + ", displayName=" + displayName + ", shortCode=" + shortCode + ", created=" + created + ", modified=" + modified + "]";
	}
}
