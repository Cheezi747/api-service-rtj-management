 ...
 * {@link se.sundsvall.rtjmanagement.operaton.service.ProcessService} (D6: BPMN is per-type,
 * deploy-time — the envelope service does NOT start processes).
 *
 * Declared as a Modulith shared module on {@link se.sundsvall.rtjmanagement.Application
 * 
...
package se.sundsvall.rtjmanagement.operaton;
