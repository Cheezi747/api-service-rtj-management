package se.sundsvall.rtjmanagement.decisions.api;
...
import se.sundsvall.rtjmanagement.decisions.service.DecisionService;
...
class DecisionResource {
	...
	DecisionResource(final DecisionService service) {
