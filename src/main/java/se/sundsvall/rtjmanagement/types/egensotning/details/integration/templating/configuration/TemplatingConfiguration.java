...
public class TemplatingConfiguration {
	...
	@Bean
	FeignBuilderCustomizer feignBuilderCustomizer(final TemplatingProperties templatingProperties, final ClientRegistrationRepository clientRegistrationRepository) {
