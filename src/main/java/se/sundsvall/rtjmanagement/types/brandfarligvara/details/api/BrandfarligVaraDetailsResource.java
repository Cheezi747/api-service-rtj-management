...
@RestController
@Validated
@RequestMapping("/{municipalityId}/{namespace}/errands/{errandId}/brandfarlig-vara-details")
@Tag(name = "Brandfarlig vara — details",
	description = "1:1 type-specific extension fields for BRANDFARLIG_VARA errands. Upsert via PUT; only valid when the errand's typeSlug is BRANDFARLIG_VARA.")
@ApiResponses(value = {
...
class BrandfarligVaraDetailsResource {

	private final BrandfarligVaraDetailsService service;

	BrandfarligVaraDetailsResource(final BrandfarligVaraDetailsService service) {
		this.service = service;
	}

	@PutMapping(consumes = APPLICATION_JSON_VALUE, produces = ALL_VALUE)
	@Operation(summary = "Upsert brandfarlig-vara details", responses = {
	...
	ResponseEntity<Void> upsertDetails(
		...
		@Valid @NotNull @RequestBody final BrandfarligVaraDetails details) {
	...
	@Operation(summary = "Read brandfarlig-vara details", responses = {
		@ApiResponse(responseCode = "200", description = "Successful Operation", useReturnTypeSchema = true),
		@ApiResponse(responseCode = "404", description = "Not Found", content = @Content(mediaType = APPLICATION_PROBLEM_JSON_VALUE, schema = @Schema(implementation = Problem.class)))
	})
	ResponseEntity<BrandfarligVaraDetails> readDetails(
	...
	@Operation(summary = "Delete brandfarlig-vara details", responses = {
		@ApiResponse(responseCode = "204", description = "Successful operation", useReturnTypeSchema = true)
	})
