package se.sundsvall.rtjmanagement.metadata.service;

import java.util.List;
import org.springframework.stereotype.Service;
import org.springframework.transaction.annotation.Transactional;
import se.sundsvall.dept44.problem.Problem;
import se.sundsvall.rtjmanagement.metadata.api.model.Lookup;
import se.sundsvall.rtjmanagement.metadata.integration.db.LookupRepository;
import se.sundsvall.rtjmanagement.metadata.integration.db.model.LookupEntity;
import se.sundsvall.rtjmanagement.metadata.integration.db.model.LookupKind;

import static org.springframework.http.HttpStatus.CONFLICT;
import static org.springframework.http.HttpStatus.NOT_FOUND;
import static se.sundsvall.rtjmanagement.metadata.service.mapper.LookupMapper.toLookup;
import static se.sundsvall.rtjmanagement.metadata.service.mapper.LookupMapper.toLookupEntity;
import static se.sundsvall.rtjmanagement.metadata.service.mapper.LookupMapper.toLookupList;
import static se.sundsvall.rtjmanagement.metadata.service.mapper.LookupMapper.updateLookupEntity;
