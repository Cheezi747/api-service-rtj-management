...
The `Application` class already has `additionalPackages = "se.sundsvall.rtjmanagement.types"`
...
```
src/main/java/se/sundsvall/rtjmanagement/
├── integration/db/
...
```
src/test/java/se/sundsvall/rtjmanagement/
