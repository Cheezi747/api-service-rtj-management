...
`se.sundsvall.rtjmanagement.integration.db.model.ErrandEntity` currently holds:
...
Single Maven module, package-per-module under `se.sundsvall.rtjmanagement`:

```
se.sundsvall.rtjmanagement
...
package se.sundsvall.rtjmanagement.types.fostercare;
```
...
import se.sundsvall.rtjmanagement.core.api.registry.ErrandTypeContribution;
import se.sundsvall.rtjmanagement.stakeholders.api.RoleDefinition;
import se.sundsvall.rtjmanagement.stakeholders.api.StakeholderRoleContribution;
